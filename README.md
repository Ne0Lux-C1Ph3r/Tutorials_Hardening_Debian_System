...
<p style='color:red'><a href="https://github.com/Ne0Lux-C1Ph3r/Tutorials_Hardening_Debian_System/blob/master/Ansible/index.md" target="_blank">```html<style="color:orange">Partiel</style>```:  Ansible hardening Debian system</a></p> 
